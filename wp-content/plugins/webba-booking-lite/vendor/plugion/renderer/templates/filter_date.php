...
<div class="plugion_input_container">
    <input  id="<?php echo $slug ?>"  name="<?php echo $field->get_name(); ?>"  class="plugion_input plugion_input_text plugion_filter_input" type="text" data-setter="date" data-getter="date" required>
