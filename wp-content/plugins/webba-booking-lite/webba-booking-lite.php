...
if ( !defined( 'WP_WEBBA_BOOKING__VERSION' ) ) {
    define( 'WP_WEBBA_BOOKING__VERSION', '4.0.47' );
}
...
if ( !function_exists( 'wbk_load_textdomain' ) ) {
    ...
    add_action( 'init', 'wbk_update_data' );
...
if ( !function_exists( 'wbk_cleanup_attachements' ) ) {
    function wbk_cleanup_attachements()
    {
        ...
        global  $wpdb ;
        $result = $wpdb->get_results( "Select * from `wbk_appointments` where attachment  <> '' LIMIT 10 ", ARRAY_A );
