...
class WBK_Date_Time_Utils
{
    ...
    public static function render_business_hours_at_day( $business_hours, $day )
    {
        ...
        for ( $time = 0 ;  $time <= 86400 ;  $time += 300 ) {
            $temp_time = $time + 2;
            $html_interval_1_1 .= '<option ' . selected( $start_time, $time, false ) . ' value="' . $temp_time . '">' . wp_date( $time_format, $time, new DateTimeZone( date_default_timezone_get() ) ) . '</option>';
        }
        ...
        for ( $time = 0 ;  $time <= 86400 ;  $time += 300 ) {
            $temp_time = $time + 2;
            $html_interval_1_2 .= '<option ' . selected( $end_time, $time, false ) . ' value="' . $temp_time . '">' . wp_date( $time_format, $time, new DateTimeZone( date_default_timezone_get() ) ) . '</option>';
        }
        ...
        if ( $interval_count == 2 ) {
            ...
            for ( $time = 0 ;  $time <= 86400 ;  $time += 300 ) {
                $temp_time = $time + 2;
                $html_interval_2_1 .= '<option ' . selected( $start_time, $time, false ) . ' value="' . $temp_time . '">' . wp_date( $time_format, $time, new DateTimeZone( date_default_timezone_get() ) ) . '</option>';
            }
            ...
            for ( $time = 0 ;  $time <= 86400 ;  $time += 300 ) {
                $temp_time = $time + 2;
                $html_interval_2_2 .= '<option ' . selected( $end_time, $time, false ) . ' value="' . $temp_time . '">' . wp_date( $time_format, $time, new DateTimeZone( date_default_timezone_get() ) ) . '</option>';
            }
        ...
        if ( $interval_count == 2 ) {
            ...
            $html .= '<div id="business_hours_' . $day . '_control" class="business_hours_control_container" >' . ' <a href="javascript:removeInterval( &#39;' . $day . '&#39; )">' . __( 'Remove the second gap', 'wbk' ) . '</a>
                      </div>';
        } else {
            $html .= '<div id="business_hours_' . $day . '_2" class="business_hours_container" ></div>';
            $html .= '<div id="business_hours_' . $day . '_control" class="business_hours_control_container" >' . ' <a href="javascript:addInterval( &#39;' . $day . '&#39; )">' . __( 'Add the second gap', 'wbk' ) . '</a>
                      </div>';
        }
