...
class WBK_Backend_Options extends WBK_Backend_Component
{
    ...
    public function initSettings()
    {
        ...
        register_setting( 'wbk_options', 'wbk_appointments_only_one_per_service', array( $this, 'validate_appointments_only_one_per_service' ) );
        add_settings_field(
    ...
    public function render_payment_item_name()
    {
        ...
        $html .= '<p class="description">' . __( 'Available placeholders: #service, #date, #time, #tr (time range), #id, #quantity', 'wbk' ) . '</p>';
        echo  $html ;
    }
