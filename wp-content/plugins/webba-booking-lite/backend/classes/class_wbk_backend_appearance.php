...
class WBK_Backend_Appearance extends WBK_Backend_Component   {
	...
	public function enqueueScripts() {
  	...
  	$slf = new SoloFramework( 'wbk_settings_data' );
 	echo '<div class="wrap">
			<h2 class="wbk_panel_title">'. __( 'Appearance', 'wbk' ) .'	<a style="text-decoration:none;" href="https://webba-booking.com/documentation/appearance-customization/" target="_blank"><span class="dashicons dashicons-editor-help"></span></a> </h2>
						'.
